...
| M3 | OQ-001 (RocksDB primary per ADR-0002); OQ-015 (profile match precedence per ADR-0006); OQ-022 (recursion guard); OQ-029 (per-event vs batched notifications); OQ-005 (reflex priority); OQ-012 (multi-monitor) |
