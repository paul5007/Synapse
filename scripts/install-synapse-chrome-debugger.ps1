...
[pscustomobject]@{
    ...
    bridge_build_id_expected = 'synapse-chrome-bridge-2026-06-17-hwnd-bounds-open-tab-v1'
    bridge_build_sha256_expected = '922a68569c4bdf9f75c822b4af02b385af522a3c97f4e4339c6814877f94a179'
