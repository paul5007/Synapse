...
[pscustomobject]@{
    ...
    bridge_build_id_expected = 'synapse-chrome-bridge-2026-06-21-tab-adopt-v1'
    bridge_build_sha256_expected = 'f6927e7983989158827f91fafe195c7d2aba88eed01681f8f87bbb4e835ae5bf'
